         ...
         <div class="span6 offset3">
            ...
            <div class="row">
               ...
               <div class="span1">
                  ...
                  <div class="span1"  style="margin-left:5px; right:0; text-align:right;"><button class="btn btn-primary btn-large" style="width:75px;">Send</button></div>
               </div>
            </div>
            </div>
         </div>
...
<?php Yii::app()->clientScript->registerScriptFile('js/charCount.js'); ?>
<?php Yii::app()->clientScript->registerScriptFile('protected/extensions/bootstrap/assets/js/bootstrap-modal.js'); ?>
<?php Yii::app()->clientScript->registerScriptFile('protected/extensions/bootstrap/assets/js/bootstrap-button.js'); ?>
<?php Yii::app()->clientScript->registerScriptFile('js/vlad.js'); ?>
<?php Yii::app()->clientScript->registerCssFile('css/vlad.css'); ?>